...
p1 <- ggplot(data,aes(x=seq(1,100,by=1),y=y)) + geom_point() + geom_vline(xintercept=10) + geom_vline(xintercept=25) + geom_vline(xintercept=50) + xlab("Position in Ranking") + ylab("y") + scale_x_continuous(expand=c(0,0), breaks=c(1,25,50,75,100)) + scale_y_continuous(expand=c(0,0)) + expand_limits(y=-20) + expand_limits(y=1020) + expand_limits(x=-2) + expand_limits(x=102) + theme(plot.margin = unit(c(0.5, 0.2, 0.5, 0.3), "lines")) + annotate("text",x=5,y=400,label="3") + annotate("text",x=17.5,y=400,label="2") + annotate("text",x=37.5,y=400,label="1") + annotate("text",x=75,y=400,label="0")
